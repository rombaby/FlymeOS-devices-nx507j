...
.field private mZteBrightnessUtils:Lcn/nubia/server/ZteBrightnessUtils;

.field private mZteControlModeAmbientLux:F
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/display/AutomaticBrightnessController$Callbacks;Landroid/os/Looper;Landroid/hardware/SensorManager;Landroid/util/Spline;III)V
    ...
    iput-boolean v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAutoBrightnessZteControlMode:Z
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/display/AutomaticBrightnessController$1;-><init>(Lcom/android/server/display/AutomaticBrightnessController;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteAutoBrightnessAdjObserver:Landroid/database/ContentObserver;
    ...
    .line 244
    new-instance v0, Lcn/nubia/server/ZteBrightnessUtils;

    invoke-direct {v0, p1}, Lcn/nubia/server/ZteBrightnessUtils;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteBrightnessUtils:Lcn/nubia/server/ZteBrightnessUtils;

    .line 245
    iget-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteBrightnessUtils:Lcn/nubia/server/ZteBrightnessUtils;

    iget-boolean v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAutoBrightnessZteControlMode:Z

    invoke-virtual {v0, v1}, Lcn/nubia/server/ZteBrightnessUtils;->setutoBrightnessZteControlModeEnable(Z)V

    .line 246
    iget-object v0, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteBrightnessUtils:Lcn/nubia/server/ZteBrightnessUtils;

    iget-object v1, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteAutoBrightnessAdjObserver:Landroid/database/ContentObserver;

    invoke-virtual {v0, v1}, Lcn/nubia/server/ZteBrightnessUtils;->zteAutoControlregisterContentObserver(Landroid/database/ContentObserver;)V
...
.method private handleLightSensorEvent(JF)V
    ...
    .line 323
    iput p3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteControlModeAmbientLux:F
...
.method private updateAutoBrightness(Z)V
    ...
    .line 492
    .local v8, "gamma":F
    iget-object v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteBrightnessUtils:Lcn/nubia/server/ZteBrightnessUtils;

    iget v3, p0, Lcom/android/server/display/AutomaticBrightnessController;->mZteControlModeAmbientLux:F

    invoke-virtual {v2, v3}, Lcn/nubia/server/ZteBrightnessUtils;->getLcdValueInZteControltMode(F)I
    ...
    iget-boolean v2, p0, Lcom/android/server/display/AutomaticBrightnessController;->mAutoBrightnessZteControlMode:Z

    if-eqz v2, :cond_5

    .line 533
    invoke-direct {p0, v11}, Lcom/android/server/display/AutomaticBrightnessController;->clampScreenBrightness(I)I
