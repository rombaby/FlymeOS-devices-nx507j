...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;
    }
.end annotation
...
.method private processSetUiccSubscriptionDone(Landroid/os/Message;)V
    ...
    check-cast v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;

    .line 285
    .local v8, "susp":Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;
    iget v4, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->slotId:I
    ...
    .line 302
    iget v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gppId:I

    if-ne v0, v9, :cond_0

    .line 303
    const-string v9, "SETUICC FAILED"

    iput-object v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gppAppStatus:Ljava/lang/String;

    .line 305
    :cond_0
    iget v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gpp2Id:I
    ...
    iput-object v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gpp2AppStatus:Ljava/lang/String;
    ...
    const-string v10, " single application "
    ...
    invoke-direct {p0, v4, v3, v9}, Lcom/android/internal/telephony/SubscriptionHelper;->broadcastSetUiccResult(III)V
    ...
    .line 319
    :cond_4
    iget-object v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gppAppStatus:Ljava/lang/String;

    const-string v10, "SETUICC FAILED"
    ...
    iget-object v9, v8, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gpp2AppStatus:Ljava/lang/String;
    ...
    const-string v10, "Exception GLOBAL in SET_UICC_SUBSCRIPTION to "
    ...
    const-string v10, " , but one cardApplication doesn\'t come back ,wait"
    ...
    .line 342
    const-string v9, "SETUICC SUCCESS"
    ...
    const-string v10, "GLOBAL in SET_UICC_SUBSCRIPTION to "
    ...
    invoke-virtual {v5, v10, v11, v3}, Lcom/android/internal/telephony/SubscriptionController;->setSubState(JI)I
    ...
    .line 383
    .end local v2    # "isPrimarySubFeatureEnable":Z
    :cond_f
    if-eq v3, v7, :cond_10
    ...
    .line 403
    .restart local v2    # "isPrimarySubFeatureEnable":Z
    :cond_11
    invoke-static {}, Lcom/android/internal/telephony/ModemStackController;->getInstance()Lcom/android/internal/telephony/ModemStackController;
...
.method public setUiccSubscription(II)V
    ...
    .line 232
    :cond_1
    new-instance v9, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;

    invoke-direct {v9, p0, p1, p2}, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;-><init>(Lcom/android/internal/telephony/SubscriptionHelper;II)V

    .line 236
    .local v9, "susp":Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;
    const/4 v2, 0x0
    ...
    .line 246
    :cond_2
    iput v2, v9, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gppId:I

    .line 247
    invoke-static {p0, v11, v2, p2, v9}, Landroid/os/Message;->obtain(Landroid/os/Handler;IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 260
    :cond_6
    iput v2, v9, Lcom/android/internal/telephony/SubscriptionHelper$SetUiccSubsParams;->app3gpp2Id:I
