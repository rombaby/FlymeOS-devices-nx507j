...
.method public varargs updateUserPrefs([Z)V
    ...
    .line 1658
    .local v10, "subInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubInfoRecord;>;"
    const/4 v4, 0x0
    ...
    .line 1661
    .local v6, "mNextActivatedSub":Landroid/telephony/SubInfoRecord;
    if-nez v10, :cond_3
    ...
    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultSubId(J)V

    .line 1668
    const-wide/16 v12, -0x1

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultVoiceSubId(J)V

    .line 1669
    const-wide/16 v12, -0x1

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultSmsSubId(J)V

    .line 1670
    const-wide/16 v12, -0x1

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->setDataSubId(J)V
    ...
    .end local v6    # "mNextActivatedSub":Landroid/telephony/SubInfoRecord;
    .end local v10    # "subInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubInfoRecord;>;"
    :cond_2
    if-eqz v5, :cond_0
    ...
    .restart local v6    # "mNextActivatedSub":Landroid/telephony/SubInfoRecord;
    .restart local v10    # "subInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/telephony/SubInfoRecord;>;"
    :cond_3
    ...
    iget-wide v12, v9, Landroid/telephony/SubInfoRecord;->subId:J

    invoke-virtual {p0, v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->getSubState(J)I
    ...
    .line 1682
    .end local v9    # "subInfo":Landroid/telephony/SubInfoRecord;
    :cond_5
    new-instance v11, Ljava/lang/StringBuilder;
    ...
    .line 1695
    iget-wide v12, v6, Landroid/telephony/SubInfoRecord;->subId:J
    ...
    iget-wide v0, v6, Landroid/telephony/SubInfoRecord;->subId:J
