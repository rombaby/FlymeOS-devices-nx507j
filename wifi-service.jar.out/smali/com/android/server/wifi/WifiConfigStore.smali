...
.method public associateWithConfiguration(Landroid/net/wifi/ScanResult;)Landroid/net/wifi/WifiConfiguration;
    ...
    .line 3225
    const-string v9, "associateWithConfiguration(): no config key "
    ...
    const-string v10, "associateWithConfiguration(): try "
    ...
    .line 3238
    .local v7, "link":Landroid/net/wifi/WifiConfiguration;
    const/4 v4, 0x0

    .line 3240
    .local v4, "doLink":Z
    iget v9, v7, Landroid/net/wifi/WifiConfiguration;->autoJoinStatus:I

    const/16 v10, 0xc8

    if-eq v9, v10, :cond_4

    iget-boolean v9, v7, Landroid/net/wifi/WifiConfiguration;->selfAdded:Z
    ...
    const-string v10, "associateWithConfiguration(): skip selfadd "
    ...
    const-string v10, "associateWithConfiguration(): skip non-PSK "
    ...
    const-string v10, "associateWithConfiguration(): found it!!! "
    ...
    .line 3257
    :cond_7
    iget-object v9, v7, Landroid/net/wifi/WifiConfiguration;->scanResultCache:Ljava/util/HashMap;
    ...
    iget-object v9, p1, Landroid/net/wifi/ScanResult;->BSSID:Ljava/lang/String;
    ...
    const-string v10, "associateWithConfiguration: will create "
    ...
    const-string v10, " and associate it with: "
    ...
    .line 3285
    iput-boolean v12, v2, Landroid/net/wifi/WifiConfiguration;->selfAdded:Z

    .line 3286
    iput-boolean v12, v2, Landroid/net/wifi/WifiConfiguration;->didSelfAdd:Z

    .line 3287
    iput-boolean v12, v2, Landroid/net/wifi/WifiConfiguration;->dirty:Z
    ...
    iput-object v9, v2, Landroid/net/wifi/WifiConfiguration;->peerWifiConfiguration:Ljava/lang/String;
    ...
    invoke-virtual {v9, v10}, Ljava/util/BitSet;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/server/wifi/WifiConfigStore;->readNetworkVariableFromSupplicantFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    .line 3293
    .local v8, "psk":Ljava/lang/String;
    if-eqz v8, :cond_f
    ...
    const-string v10, " transfer PSK : "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, v2, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;
    ...
    iput-object v9, v7, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;

    .line 3304
    :cond_c
    iget-object v9, v2, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;
    ...
    iput-object v9, v2, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;
    ...
    .line 3315
    .end local v8    # "psk":Ljava/lang/String;
    :goto_2
    if-eqz v2, :cond_3

    .end local v4    # "doLink":Z
    .end local v7    # "link":Landroid/net/wifi/WifiConfiguration;
    :cond_e
    move-object v7, v2
    ...
    .line 3310
    .restart local v4    # "doLink":Z
    .restart local v7    # "link":Landroid/net/wifi/WifiConfiguration;
    .restart local v8    # "psk":Ljava/lang/String;
    :cond_f
    const/4 v2, 0x0
