...
.field private static final TLV_SSID:I = 0x0
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/wifi/IWifiManager;)V
    ...
    .line 97
    iput v0, p0, Landroid/net/wifi/WifiManager;->mNumWifi:I

    .line 98
    iput v0, p0, Landroid/net/wifi/WifiManager;->mWriteWifiNum:I
...
.method private TlvWifiConfig(Landroid/net/wifi/WifiConfiguration;[B)I
    ...
    invoke-direct {p0, v5, v3}, Landroid/net/wifi/WifiManager;->tlvencode(ILjava/lang/String;)[B
    ...
    invoke-direct {p0, v3, v4}, Landroid/net/wifi/WifiManager;->tlvencode(ILjava/lang/String;)[B
    ...
    invoke-direct {p0, v3, v4}, Landroid/net/wifi/WifiManager;->makeString(Ljava/util/BitSet;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v0}, Landroid/net/wifi/WifiManager;->tlvencode(ILjava/lang/String;)[B
...
.method private addOrUpdateNetwork2(Landroid/net/wifi/WifiConfiguration;)I
    .locals 2
    .param p1, "config"    # Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->addOrUpdateNetwork2(Landroid/net/wifi/WifiConfiguration;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setKeyMgmt(Ljava/lang/String;)I
    ...
    .line 2817
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiManager;->isEmpty(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v7}, Landroid/net/wifi/WifiManager;->lookupString(Ljava/lang/String;[Ljava/lang/String;)I
...
.method private tlvdecode([B)Ljava/util/List;
    ...
    .line 2746
    invoke-direct {p0, v4}, Landroid/net/wifi/WifiManager;->Array2Typeint([B)I

    move-result v8

    .line 2747
    invoke-direct {p0, v7}, Landroid/net/wifi/WifiManager;->Array2Typeint([B)I
    ...
    invoke-direct {p0, v6}, Landroid/net/wifi/WifiManager;->setKeyMgmt(Ljava/lang/String;)I
...
.method private tlvencode(II)[B
    ...
    .line 2721
    .local v3, "tmpValue":[B
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiManager;->int2TypeArray(I)[B

    move-result-object v2

    .line 2722
    invoke-direct {p0, p2}, Landroid/net/wifi/WifiManager;->int2TypeArray(I)[B
    ...
    invoke-direct {p0, v4}, Landroid/net/wifi/WifiManager;->int2TypeArray(I)[B
...
.method public achieveConfiguredNetworks()[B
    ...
    invoke-interface {v10}, Landroid/net/wifi/IWifiManager;->getConfigInformation()Ljava/util/List;
    ...
    iput v10, p0, Landroid/net/wifi/WifiManager;->mNumWifi:I
    ...
    invoke-direct {p0, v1, v2}, Landroid/net/wifi/WifiManager;->TlvWifiConfig(Landroid/net/wifi/WifiConfiguration;[B)I
    ...
    invoke-static {v2, v10, v0, v7, v3}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    invoke-static {v0, v10, v8, v11, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public numWifiInformation()I
    ...
    .prologue
    .line 676
    iget v0, p0, Landroid/net/wifi/WifiManager;->mNumWifi:I
...
.method public setConfiguredNetworks([B)I
    ...
    iput v4, p0, Landroid/net/wifi/WifiManager;->mWriteWifiNum:I

    .line 654
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiManager;->tlvdecode([B)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Landroid/net/wifi/WifiManager;->addOrUpdateNetwork2(Landroid/net/wifi/WifiConfiguration;)I
    ...
    :cond_1
    iget v4, p0, Landroid/net/wifi/WifiManager;->mWriteWifiNum:I
    ...
    .end local v2    # "i$":Ljava/util/Iterator;
    :cond_2
    iget v3, p0, Landroid/net/wifi/WifiManager;->mWriteWifiNum:I
