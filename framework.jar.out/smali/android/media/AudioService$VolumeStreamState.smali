...
.method private declared-synchronized muteCount()I
    ...
    .line 3854
    .local v2, "deathHandlers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;>;"
    ...
    .line 3856
    .local v1, "deathHandler":Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    const/4 v3, 0x0
    ...
    .end local v1    # "deathHandler":Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    check-cast v1, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;

    .line 3858
    .restart local v1    # "deathHandler":Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    if-eqz v1, :cond_0

    .line 3859
    # getter for: Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->mMuteCount:I
    invoke-static {v1}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->access$2300(Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 3852
    .end local v1    # "deathHandler":Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    .end local v2    # "deathHandlers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;>;"
    .end local v3    # "i":I
    .end local v4    # "size":I
    :catchall_0
    move-exception v5
...
.method public readSettings()V
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$4300(Landroid/media/AudioService;)Lnubia/media/NubiaVolume;
