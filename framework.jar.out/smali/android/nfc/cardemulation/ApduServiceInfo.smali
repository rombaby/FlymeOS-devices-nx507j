...
.method public constructor <init>(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;Z)V
    ...
    .line 231
    :cond_2
    const-string v20, "com.nxp.nfc.extensions"
    ...
    const-string v21, "No com.nxp.nfc.extensions meta-data"
    ...
    const-string/jumbo v20, "offhost-apdu-service"
    ...
    const-string/jumbo v20, "payment"
    ...
    const-string v20, "aid-prefix-filter"
    ...
    const-string/jumbo v20, "secure-element"
    ...
    invoke-direct/range {v20 .. v22}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;-><init>(II)V
    ...
    invoke-virtual {v0, v13}, Landroid/nfc/cardemulation/ApduServiceInfo;->nxp_parser_se(Landroid/content/res/XmlResourceParser;)V
...
.method public constructor <init>(Landroid/content/pm/ResolveInfo;ZLjava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;ZII)V
    ...
    invoke-direct {v2, v3, v4}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;-><init>(II)V

    iput-object v2, p0, Landroid/nfc/cardemulation/ApduServiceInfo;->mSeExtension:Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
...
.method public nxp_parser_se(Landroid/content/res/XmlResourceParser;)V
    .locals 12
    .param p1, "nxpParser"    # Landroid/content/res/XmlResourceParser;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xmlpull/v1/XmlPullParserException;,
            Ljava/io/IOException;
    ...
    .line 699
    .local v5, "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    if-eqz p1, :cond_d
    ...
    const-string v11, "Meta-data does not start with <extensions> tag "
    ...
    .line 719
    const-string/jumbo v9, "nxp-se-ext-group"
    ...
    invoke-interface {p1, v9, v10}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "Unsupported se name: "
    ...
    const-string/jumbo v9, "se-power-state"
    ...
    .line 730
    .local v2, "powerName":Ljava/lang/String;
    const/4 v9, 0x0
    ...
    .line 731
    .local v4, "powerValue":Z
    :goto_3
    const-string v9, "SwitchOn"
    ...
    .line 733
    .restart local v4    # "powerValue":Z
    :cond_6
    const-string v9, "SwitchOff"
    ...
    .line 740
    .end local v2    # "powerName":Ljava/lang/String;
    .end local v4    # "powerValue":Z
    :cond_8
    if-eqz v7, :cond_c

    .line 742
    new-instance v6, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    ...
    .end local v3    # "powerState":I
    :goto_5
    invoke-direct {v6, v9, v3}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;-><init>(II)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 743
    .end local v5    # "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    .local v6, "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    :try_start_2
    iget-object v9, p0, Landroid/nfc/cardemulation/ApduServiceInfo;->mSeExtension:Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;

    sget v9, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;->seId:I

    sput v9, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;->seId:I

    .line 744
    iget-object v9, p0, Landroid/nfc/cardemulation/ApduServiceInfo;->mSeExtension:Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;

    sget v9, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;->powerState:I

    sput v9, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;->powerState:I

    .line 745
    const-string v9, "ApduServiceInfo"

    iget-object v10, p0, Landroid/nfc/cardemulation/ApduServiceInfo;->mSeExtension:Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;

    invoke-virtual {v10}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;->toString()Ljava/lang/String;
    ...
    .line 753
    .end local v6    # "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    .restart local v5    # "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    :goto_6
    invoke-interface {p1}, Landroid/content/res/XmlResourceParser;->close()V
    ...
    invoke-direct {v6, v9, v10}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;-><init>(II)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 749
    .end local v5    # "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    .restart local v6    # "seExtension":Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    :try_start_4
    iget-object v9, p0, Landroid/nfc/cardemulation/ApduServiceInfo;->mSeExtension:Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    ...
    .end local v8    # "tagName":Ljava/lang/String;
    :cond_d
    new-instance v5, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;
    ...
    invoke-direct {v5, v9, v10}, Landroid/nfc/cardemulation/ApduServiceInfo$ESeInfo;-><init>(II)V
